...
CREATE TABLE `schedule` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_schedule_flight1_idx` (`flight_id`),
  CONSTRAINT `fk_schedule_flight1` FOREIGN KEY (`flight_id`) REFERENCES `flight` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
