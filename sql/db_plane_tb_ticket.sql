...
CREATE TABLE `tb_ticket` (
  ...
  `sche_num` varchar(30) DEFAULT NULL,
  `seat` int(11) DEFAULT NULL,
  `t_status` int(11) DEFAULT NULL,
  `price` decimal(6,1) DEFAULT NULL,
  `seat_type` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `seat_fk_idx` (`seat`),
  CONSTRAINT `seat_fk` FOREIGN KEY (`seat`) REFERENCES `tb_seat_type` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `shc_fk` FOREIGN KEY (`id`) REFERENCES `tb_schedule` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
